...
const TechOrbit = dynamic(() => import('../../3d/tech-orbit'), { ssr: false });
    ...
    <div id="skills" className="relative z-50 border-t my-12 lg:my-24 border-[#25213b]">
      ...
      <div className="flex flex-col items-center my-8">
        <div className="w-full flex flex-col items-center justify-center mb-12">
          ...
          <p className="text-center text-sm text-gray-400 mt-2 tracking-widest uppercase">Tech Ecosystem</p>
        </div>
        
        <div className="w-full w-max-[100vw] overflow-hidden my-4">
          <Marquee
            gradient={false}
            speed={80}
            pauseOnHover={true}
