...
import grpc from '../app/assets/svg/skills/Grpc.svg';
...
import meilisearch from '../app/assets/svg/skills/meilisearch.svg';
...
export function skillsImage(skill: string): any {
